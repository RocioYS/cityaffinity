...
CREATE TABLE `localizacion` (
  ...
  `localizacioncol` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idlocalizacion`),
  CONSTRAINT `idciudad` FOREIGN KEY (`idlocalizacion`) REFERENCES `ciudad` (`idciudad`),
  CONSTRAINT `idpais` FOREIGN KEY (`idlocalizacion`) REFERENCES `pais` (`idpais`)
